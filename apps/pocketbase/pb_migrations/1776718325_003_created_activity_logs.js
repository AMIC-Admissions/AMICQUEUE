...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_6619540567",
    "indexes": ["CREATE INDEX idx_activity_logs_timestamp ON activity_logs (timestamp)"],
    "listRule": "",
    "name": "activity_logs",
    "system": false,
    "type": "base",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_6619540567");
