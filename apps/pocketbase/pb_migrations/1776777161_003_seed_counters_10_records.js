...
migrate((app) => {
  ...
  const record2 = new Record(collection);
    ...
    record2.set("name", "Counter 3");
    record2.set("status", "available");
  ...
  const record5 = new Record(collection);
    ...
    record5.set("name", "Counter 6");
    record5.set("status", "available");
  ...
  const record7 = new Record(collection);
    ...
    record7.set("name", "Counter 8");
    record7.set("status", "available");
  ...
  const record8 = new Record(collection);
    ...
    record8.set("name", "Counter 9");
    record8.set("status", "available");
  ...
  const record9 = new Record(collection);
    ...
    record9.set("name", "Counter 10");
    record9.set("status", "available");
